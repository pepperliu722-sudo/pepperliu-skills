...
- type scale, width, case, alignment, and interaction with imagery;
- image-making method;
- material and edge behavior;
- metaphor class;
- emotional temperature;
- what makes the reference surprising.
...
- no protected character, logo, exact composition, or signature treatment is copied;
